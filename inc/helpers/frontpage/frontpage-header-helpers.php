...
/**
 * Front page header content custom links horizontal alignment
 */
if ( ! function_exists( 'ubik_frontpage_header_content_links_horizontal_alignment' ) ) {
	
	function ubik_frontpage_header_content_links_horizontal_alignment() {

		// Get setting from customizer
		$alignment = get_theme_mod( 'ubik_frontpage_header_content_links_horizontal_alignment', 'center' );
		
		// Sanitize to make sure it isn't empty
		$alignment = $alignment ?  $alignment : 'center';

		// Apply filters and return
		return apply_filters( 'ubik_frontpage_header_content_links_horizontal_alignment_filter', $alignment );
...
/**
 * Front page header content custom links device visibility
 */
if ( ! function_exists( 'ubik_frontpage_header_content_links_device_visibility' ) ) {
	
	function ubik_frontpage_header_content_links_device_visibility() {

		// Get setting from customizer
		$visibility = get_theme_mod( 'ubik_frontpage_header_content_links_device_visibility', 'all-devices' );
		
		// Sanitize to make sure it isn't empty
		$visibility = $visibility ?  $visibility : 'all-devices';

		// Apply filters and return
		return apply_filters( 'ubik_frontpage_header_content_links_device_visibility_filter', $visibility );
...
/**
 * Front page header content links direction
 */
if ( ! function_exists( 'ubik_frontpage_header_content_links_direction' ) ) {
	
	function ubik_frontpage_header_content_links_direction() {

		// Get setting from customizer
		$direction = get_theme_mod( 'ubik_frontpage_header_content_links_direction', 'row' );
		
		// Sanitize to make sure it isn't empty
		$direction = $direction ?  $direction : 'column';

		// Apply filters and return
		return apply_filters( 'ubik_frontpage_header_content_links_direction_filter', $direction );
...
/**
 * Add classes to front page header content links
 *
 * @since 1.0.0
 */
if ( ! function_exists( 'ubik_frontpage_header_content_links_classes' ) ) {
	
	function ubik_frontpage_header_content_links_classes() {

		// Horizontal alignment
		$horizontal_alignment = ubik_frontpage_header_content_links_horizontal_alignment();

		// Device visibility
		$visibility = ubik_frontpage_header_content_links_device_visibility();

		// Direction of header content links
		$direction = ubik_frontpage_header_content_links_direction();
		...
		// Apply filters for child theming
		$classes = apply_filters( 'ubik_frontpage_header_content_links_classes_filter', $classes );
