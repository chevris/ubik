...
if ( ! function_exists( 'ubik_general_css' ) ) {
  ...
  function ubik_general_css( $output ) {
		...
		if ( ! empty( $h1_font_size_desktop ) ) {
			$css .= 'h1{font-size:'. $h1_font_size_desktop .'px;}';
		}
		if ( ! empty( $h1_font_size_tablet ) ) {
			$css .= '@media screen and (max-width: 63.9375em) {h1{font-size:'. $h1_font_size_tablet .'px;}}';
		}
		if ( ! empty( $h1_font_size_mobile ) ) {
			$css .= '@media screen and (max-width: 39.9375em) {h1{font-size:'. $h1_font_size_mobile .'px;}}';
		}

		// H2 font size
		if ( ! empty( $h2_font_size_desktop ) ) {
			$css .= 'h2{font-size:'. $h2_font_size_desktop .'px;}';
		}
		if ( ! empty( $h2_font_size_tablet ) ) {
			$css .= '@media screen and (max-width: 63.9375em) {h2{font-size:'. $h2_font_size_tablet .'px;}}';
		}
		if ( ! empty( $h2_font_size_mobile ) ) {
			$css .= '@media screen and (max-width: 39.9375em) {h2{font-size:'. $h2_font_size_mobile .'px;}}';
		}

		// H3 font size
		if ( ! empty( $h3_font_size_desktop ) ) {
			$css .= 'h3{font-size:'. $h3_font_size_desktop .'px;}';
		}
		if ( ! empty( $h3_font_size_tablet ) ) {
			$css .= '@media screen and (max-width: 63.9375em) {h3{font-size:'. $h3_font_size_tablet .'px;}}';
		}
		if ( ! empty( $h3_font_size_mobile ) ) {
			$css .= '@media screen and (max-width: 39.9375em) {h3{font-size:'. $h3_font_size_mobile .'px;}}';
		}

		// H4 font size
		if ( ! empty( $h4_font_size_desktop ) ) {
			$css .= 'h4{font-size:'. $h4_font_size_desktop .'px;}';
		}
		if ( ! empty( $h4_font_size_tablet ) ) {
			$css .= '@media screen and (max-width: 63.9375em) {h4{font-size:'. $h4_font_size_tablet .'px;}}';
		}
		if ( ! empty( $h4_font_size_mobile ) ) {
			$css .= '@media screen and (max-width: 39.9375em) {h4{font-size:'. $h4_font_size_mobile .'px;}}';
		}

		// H5 font size
		if ( ! empty( $h5_font_size_desktop ) ) {
			$css .= 'h5{font-size:'. $h5_font_size_desktop .'px;}';
		}
		if ( ! empty( $h5_font_size_tablet ) ) {
			$css .= '@media screen and (max-width: 63.9375em) {h5{font-size:'. $h5_font_size_tablet .'px;}}';
		}
		if ( ! empty( $h5_font_size_mobile ) ) {
			$css .= '@media screen and (max-width: 39.9375em) {h5{font-size:'. $h5_font_size_mobile .'px;}}';
		}

		// H6 font size
		if ( ! empty( $h6_font_size_desktop ) ) {
			$css .= 'h6{font-size:'. $h6_font_size_desktop .'px;}';
		}
		if ( ! empty( $h6_font_size_tablet ) ) {
			$css .= '@media screen and (max-width: 63.9375em) {h6{font-size:'. $h6_font_size_tablet .'px;}}';
		}
		if ( ! empty( $h6_font_size_mobile ) ) {
			$css .= '@media screen and (max-width: 39.9375em) {h6{font-size:'. $h6_font_size_mobile .'px;}}';
		}
		...
		if ( 'classic' == $blog_style ) {
			...
			if ( ! empty( $classic_entry_title_font_size_desktop ) && '1' == get_theme_mod('ubik_classic_entry_title_typography_heading','0') ) {
				$css .= '.classic-entry .entry-title h2{font-size:'. $classic_entry_title_font_size_desktop .'px;}';
			}
			if ( ! empty( $classic_entry_title_font_size_tablet ) && '1' == get_theme_mod('ubik_classic_entry_title_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.classic-entry .entry-title h2{font-size:'. $classic_entry_title_font_size_tablet .'px;}}';
			}
			if ( ! empty( $classic_entry_title_font_size_mobile ) && '1' == get_theme_mod('ubik_classic_entry_title_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.classic-entry .entry-title h2{font-size:'. $classic_entry_title_font_size_mobile .'px;}}';
			}
			...
			if ( ! empty( $classic_entry_meta_font_size_desktop ) && '1' == get_theme_mod('ubik_classic_entry_meta_typography_heading','0') ) {
				$css .= '.classic-entry .entry-meta{font-size:'. $classic_entry_meta_font_size_desktop .'px;}';
			}
			if ( ! empty( $classic_entry_meta_font_size_tablet ) && '1' == get_theme_mod('ubik_classic_entry_meta_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.classic-entry .entry-meta{font-size:'. $classic_entry_meta_font_size_tablet .'px;}}';
			}
			if ( ! empty( $classic_entry_meta_font_size_mobile ) && '1' == get_theme_mod('ubik_classic_entry_meta_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.classic-entry .entry-meta{font-size:'. $classic_entry_meta_font_size_mobile .'px;}}';
			}
		...
		if ( 'card' == $blog_style ) {
			...
			if ( ! empty( $card_entry_title_font_size_desktop ) && '1' == get_theme_mod('ubik_card_entry_title_typography_heading','0') ) {
				$css .= '.card-entry .entry-title h2{font-size:'. $card_entry_title_font_size_desktop .'px;}';
			}
			if ( ! empty( $card_entry_title_font_size_tablet ) && '1' == get_theme_mod('ubik_card_entry_title_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.card-entry .entry-title h2{font-size:'. $card_entry_title_font_size_tablet .'px;}}';
			}
			if ( ! empty( $card_entry_title_font_size_mobile ) && '1' == get_theme_mod('ubik_card_entry_title_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.card-entry .entry-title h2{font-size:'. $card_entry_title_font_size_mobile .'px;}}';
			}

			// Entry meta font size
			if ( ! empty( $card_entry_meta_font_size_desktop ) && '1' == get_theme_mod('ubik_card_entry_meta_typography_heading','0') ) {
				$css .= '.card-entry .entry-meta{font-size:'. $card_entry_meta_font_size_desktop .'px;}';
			}
			if ( ! empty( $card_entry_meta_font_size_tablet ) && '1' == get_theme_mod('ubik_card_entry_meta_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.card-entry .entry-meta{font-size:'. $card_entry_meta_font_size_tablet .'px;}}';
			}
			if ( ! empty( $card_entry_meta_font_size_mobile ) && '1' == get_theme_mod('ubik_card_entry_meta_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.card-entry .entry-meta{font-size:'. $card_entry_meta_font_size_mobile .'px;}}';
			}
		...
		if ( 'h-card' == $blog_style ) {
			...
			if ( ! empty( $h_card_height_desktop ) && '200' != $h_card_height_desktop ) {
				$css .= '.h-card-entry{min-height:'. $h_card_height_desktop .'px;}';
			}
			if ( ! empty( $h_card_height_tablet ) ) {
				$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em) {.h-card-entry{min-height:'. $h_card_height_tablet .'px;}}';
			}
			if ( ! empty( $h_card_height_mobile ) ) {
				$css .= '@media screen and (max-width: 39.9375em) {.h-card-entry{min-height:'. $h_card_height_mobile .'px;}}';
			}

			// horizontal cards custom height
			if ( ! empty( $h_card_custom_height_desktop ) ) {
				$css .= '.h-card-entry{height:'. $h_card_custom_height_desktop .'px;}';
			}
			if ( ! empty( $h_card_custom_height_tablet ) ) {
				$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em) {.h-card-entry{height:'. $h_card_custom_height_tablet .'px;}}';
			}
			if ( ! empty( $h_card_custom_height_mobile ) ) {
				$css .= '@media screen and (max-width: 39.9375em) {.h-card-entry{height:'. $h_card_custom_height_mobile .'px;}}';
			}

			// horizontal cards image width
			if ( ! empty( $h_card_image_width_desktop ) && '40' != $h_card_image_width_desktop ) {
				$css .= '.h-card-entry__img{width:'. $h_card_image_width_desktop .'%;}';
				$css .= '.h-card-entry__stacked{width:calc(100% - '. $h_card_image_width_desktop .'%);}';
			}
			if ( ! empty( $h_card_image_width_tablet ) ) {
				$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em) {.h-card-entry__img{width:'. $h_card_image_width_tablet .'%;}}';
				$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em) {.h-card-entry__stacked{width:calc(100% - '. $h_card_image_width_tablet .'%);}}';
			}
			if ( ! empty( $h_card_image_width_mobile ) ) {
				$css .= '@media screen and (max-width: 39.9375em) {.h-card-entry__img{width:'. $h_card_image_width_mobile .'%;}}';
				$css .= '@media screen and (max-width: 39.9375em) {.h-card-entry__stacked{width:calc(100% - '. $h_card_image_width_mobile .'%);}}';
			}
			...
			if ( isset( $h_card_top_margin ) && '0' != $h_card_top_margin && '' != $h_card_top_margin
				...
				$css .= '.h-card-entry{margin:'. ubik_spacing_css( $h_card_top_margin, $h_card_right_margin, $h_card_bottom_margin, $h_card_left_margin ) .'}';
			}
			if ( isset( $h_card_top_margin_tablet ) && '' != $h_card_top_margin_tablet
				...
				$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em){.h-card-entry{margin:'. ubik_spacing_css( $h_card_top_margin_tablet, $h_card_right_margin_tablet, $h_card_bottom_margin_tablet, $h_card_left_margin_tablet ) .'}}';
			}
			if ( isset( $h_card_top_margin_mobile ) && '' != $h_card_top_margin_mobile
				...
				$css .= '@media screen and (max-width: 39.9375em){.h-card-entry{margin:'. ubik_spacing_css( $h_card_top_margin_mobile, $h_card_right_margin_mobile, $h_card_bottom_margin_mobile, $h_card_left_margin_mobile ) .'}}';
			}

			// Entry title font size
			if ( ! empty( $h_card_entry_title_font_size_desktop ) && '1' == get_theme_mod('ubik_h_card_entry_title_typography_heading','0') ) {
				$css .= '.h-card-entry__stacked .entry-title h2{font-size:'. $h_card_entry_title_font_size_desktop .'px;}';
			}
			if ( ! empty( $h_card_entry_title_font_size_tablet ) && '1' == get_theme_mod('ubik_h_card_entry_title_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.h-card-entry__stacked .entry-title h2{font-size:'. $h_card_entry_title_font_size_tablet .'px;}}';
			}
			if ( ! empty( $h_card_entry_title_font_size_mobile ) && '1' == get_theme_mod('ubik_h_card_entry_title_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.h-card-entry__stacked .entry-title h2{font-size:'. $h_card_entry_title_font_size_mobile .'px;}}';
			}

			// Entry meta font size
			if ( ! empty( $h_card_entry_meta_font_size_desktop ) && '1' == get_theme_mod('ubik_h_card_entry_meta_typography_heading','0') ) {
				$css .= '.h-card-entry__stacked .entry-meta{font-size:'. $h_card_entry_meta_font_size_desktop .'px;}';
			}
			if ( ! empty( $h_card_entry_meta_font_size_tablet ) && '1' == get_theme_mod('ubik_h_card_entry_meta_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.h-card-entry__stacked .entry-meta{font-size:'. $h_card_entry_meta_font_size_tablet .'px;}}';
			}
			if ( ! empty( $h_card_entry_meta_font_size_mobile ) && '1' == get_theme_mod('ubik_h_card_entry_meta_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.h-card-entry__stacked .entry-meta{font-size:'. $h_card_entry_meta_font_size_mobile .'px;}}';
			}
			...
			if ( isset( $h_card_image_title_top_padding ) && '' != $h_card_image_title_top_padding
				...
				$css .= '.h-card-entry__img .entry-img-inner-content .entry-image-title{padding:'. ubik_spacing_css( $h_card_image_title_top_padding, $h_card_image_title_right_padding, $h_card_image_title_bottom_padding, $h_card_image_title_left_padding ) .'}';
			}
			if ( isset( $h_card_image_title_top_padding_tablet ) && '' != $h_card_image_title_top_padding_tablet
				...
				$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em){.h-card-entry__img .entry-img-inner-content .entry-image-title{padding:'. ubik_spacing_css( $h_card_image_title_top_padding_tablet, $h_card_image_title_right_padding_tablet, $h_card_image_title_bottom_padding_tablet, $h_card_image_title_left_padding_tablet ) .'}}';
			}
			if ( isset( $h_card_image_title_top_padding_mobile ) && '' != $h_card_image_title_top_padding_mobile
				...
				$css .= '@media screen and (max-width: 39.9375em){.h-card-entry__img .entry-img-inner-content .entry-image-title{padding:'. ubik_spacing_css( $h_card_image_title_top_padding_mobile, $h_card_image_title_right_padding_mobile, $h_card_image_title_bottom_padding_mobile, $h_card_image_title_left_padding_mobile ) .'}}';
			}
			...
			if ( ! empty( $h_card_entry_image_title_font_size_desktop ) && '1' == get_theme_mod('ubik_h_card_entry_image_title_typography_heading','0') ) {
				$css .= '.h-card-entry__img .entry-img-inner-content .entry-image-title h2{font-size:'. $h_card_entry_image_title_font_size_desktop .'px;}';
			}
			if ( ! empty( $h_card_entry_image_title_font_size_tablet ) && '1' == get_theme_mod('ubik_h_card_entry_image_title_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.h-card-entry__img .entry-img-inner-content .entry-image-title h2{font-size:'. $h_card_entry_image_title_font_size_tablet .'px;}}';
			}
			if ( ! empty( $h_card_entry_image_title_font_size_mobile ) && '1' == get_theme_mod('ubik_h_card_entry_image_title_typography_heading','0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.h-card-entry__img .entry-img-inner-content .entry-image-title h2{font-size:'. $h_card_entry_image_title_font_size_mobile .'px;}}';
			}
		...
		if ( ! empty( $single_title_font_size_desktop ) && '1' == get_theme_mod('ubik_single_title_typography_heading','0') ) {
			$css .= '.single-title .single-title__title{font-size:'. $single_title_font_size_desktop .'px;}';
		}
		if ( ! empty( $single_title_font_size_tablet ) && '1' == get_theme_mod('ubik_single_title_typography_heading','0') ) {
			$css .= '@media screen and (max-width: 63.9375em) {.single-title .single-title__title{font-size:'. $single_title_font_size_tablet .'px;}}';
		}
		if ( ! empty( $single_title_font_size_mobile ) && '1' == get_theme_mod('ubik_single_title_typography_heading','0') ) {
			$css .= '@media screen and (max-width: 39.9375em) {.single-title .single-title__title{font-size:'. $single_title_font_size_mobile .'px;}}';
		}

		// Single meta font size
		if ( ! empty( $single_meta_font_size_desktop ) && '1' == get_theme_mod('ubik_single_meta_typography_heading','0') ) {
			$css .= '.single-meta{font-size:'. $single_meta_font_size_desktop .'px;}';
		}
		if ( ! empty( $single_meta_font_size_tablet ) && '1' == get_theme_mod('ubik_single_meta_typography_heading','0') ) {
			$css .= '@media screen and (max-width: 63.9375em) {.single-meta{font-size:'. $single_meta_font_size_tablet .'px;}}';
		}
		if ( ! empty( $single_meta_font_size_mobile ) && '1' == get_theme_mod('ubik_single_meta_typography_heading','0') ) {
			$css .= '@media screen and (max-width: 39.9375em) {.single-meta{font-size:'. $single_meta_font_size_mobile .'px;}}';
		}
		...
		if ( ubik_frontpage_header_display() ) {
			...
			if ( 'image' == $frontpage_header_format ) {
				...
				if ( ! empty( $frontpage_image_header_height_tablet ) ) {
					$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em) {.frontpage-image-header{min-height:'. $frontpage_image_header_height_tablet .'px;}}';
				}
				if ( ! empty( $frontpage_image_header_height_mobile ) ) {
					$css .= '@media screen and (max-width: 39.9375em) {.frontpage-image-header{min-height:'. $frontpage_image_header_height_mobile .'px;}}';
				}

				// Front page image-header background image
				if ( ! empty( $frontpage_bg_img ) ) {

					$css .= '.frontpage-image-header{background-image: url( '. $frontpage_bg_img .' );}';

					if ( ! empty( $frontpage_bg_img_position ) ) {
						$css .= '.frontpage-image-header{background-position:'. $frontpage_bg_img_position .';}';
					}

					if ( ! empty( $frontpage_bg_img_attachment ) ) {
						$css .= '.frontpage-image-header{background-attachment:'. $frontpage_bg_img_attachment .';}';
					}

					if ( ! empty( $frontpage_bg_img_repeat ) ) {
						$css .= '.frontpage-image-header{background-repeat:'. $frontpage_bg_img_repeat .';}';
					}

					if ( ! empty( $frontpage_bg_img_size ) ) {
						$css .= '.frontpage-image-header{background-size:'. $frontpage_bg_img_size .';}';
					}
				...
				if ( ! empty( $frontpage_content_logo_max_height_desktop ) && '50' != $frontpage_content_logo_max_height_desktop ) {
					$css .= '.frontpage-header-content .custom-logo{max-height:'. $frontpage_content_logo_max_height_desktop .'px;}';
				}
				if ( ! empty( $frontpage_content_logo_max_height_tablet ) ) {
					$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em){.frontpage-header-content .custom-logo{max-height:'. $frontpage_content_logo_max_height_tablet .'px;}}';
				}
				if ( ! empty( $frontpage_content_logo_max_height_mobile ) ) {
					$css .= '@media screen and (max-width: 39.9375em){.frontpage-header-content .custom-logo{max-height:'. $frontpage_content_logo_max_height_mobile .'px;}}';
				}
				...
				if ( ! empty( $frontpage_content_tagline_font_size_desktop ) && '1' == get_theme_mod('ubik_frontpage_header_content_site_tagline_typography_heading', '0') ) {
					$css .= '.frontpage-header-content__tagline .site-tagline{font-size:'. $frontpage_content_tagline_font_size_desktop .'px;}';
				}
				if ( ! empty( $frontpage_content_tagline_font_size_tablet ) && '1' == get_theme_mod('ubik_frontpage_header_content_site_tagline_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.frontpage-header-content__tagline .site-tagline{font-size:'. $frontpage_content_tagline_font_size_tablet .'px;}}';
				}
				if ( ! empty( $frontpage_content_tagline_font_size_mobile ) && '1' == get_theme_mod('ubik_frontpage_header_content_site_tagline_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 39.9375em) {.frontpage-header-content__tagline .site-tagline{font-size:'. $frontpage_content_tagline_font_size_mobile .'px;}}';
				}
				...
				if ( ! empty( $frontpage_content_page_title_font_size_desktop ) && '1' == get_theme_mod('ubik_frontpage_header_content_page_title_typography_heading', '0') ) {
					$css .= '.frontpage-header-content__page-title .site-page-title{font-size:'. $frontpage_content_page_title_font_size_desktop .'px;}';
				}
				if ( ! empty( $frontpage_content_page_title_font_size_tablet ) && '1' == get_theme_mod('ubik_frontpage_header_content_page_title_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.frontpage-header-content__page-title .site-page-title{font-size:'. $frontpage_content_page_title_font_size_tablet .'px;}}';
				}
				if ( ! empty( $frontpage_content_page_title_font_size_mobile ) && '1' == get_theme_mod('ubik_frontpage_header_content_page_title_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 39.9375em) {.frontpage-header-content__page-title .site-page-title{font-size:'. $frontpage_content_page_title_font_size_mobile .'px;}}';
				}
				...
				if ( ! empty( $frontpage_content_nav_font_size_desktop ) && '1' == get_theme_mod('ubik_frontpage_header_content_nav_typography_heading', '0') ) {
					$css .= '.frontpage-header-content__nav{font-size:'. $frontpage_content_nav_font_size_desktop .'px;}';
				}
				if ( ! empty( $frontpage_content_nav_font_size_tablet ) && '1' == get_theme_mod('ubik_frontpage_header_content_nav_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.frontpage-header-content__nav{font-size:'. $frontpage_content_nav_font_size_tablet .'px;}}';
				}
				if ( ! empty( $frontpage_content_nav_font_size_mobile ) && '1' == get_theme_mod('ubik_frontpage_header_content_nav_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 39.9375em) {.frontpage-header-content__nav{font-size:'. $frontpage_content_nav_font_size_mobile .'px;}}';
				}
				...
				if ( ! empty( $frontpage_content_text_font_size_desktop ) && '1' == get_theme_mod('ubik_frontpage_header_content_text_typography_heading', '0') ) {
					$css .= '.frontpage-header-content__text, .frontpage-header-content__text p{font-size:'. $frontpage_content_text_font_size_desktop .'px;}';
				}
				if ( ! empty( $frontpage_content_text_font_size_tablet ) && '1' == get_theme_mod('ubik_frontpage_header_content_text_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.frontpage-header-content__text, .frontpage-header-content__text p{font-size:'. $frontpage_content_text_font_size_tablet .'px;}}';
				}
    		...
    		$frontpage_logo_max_height_tablet = get_theme_mod( 'ubik_frontpage_menubar_logo_max_height_tablet', '50' );
				...
				if ( ! empty( $frontpage_menubar_bg_color ) && ! ubik_frontpage_image_header_menubar_deactivate() && '1' == get_theme_mod('ubik_frontpage_menubar_color_heading', '0') ) {
					$css .= '#header .frontpage-menu-bar{background-color:'. $frontpage_menubar_bg_color .';}';
				}
				...
				if ( ! empty( $frontpage_menubar_borders_color ) && ! ubik_frontpage_image_header_menubar_deactivate() && '1' == get_theme_mod('ubik_frontpage_menubar_color_heading', '0') ) {
					$css .= '#header .frontpage-menu-bar-inner{border-color:'. $frontpage_menubar_borders_color .';}';
				}

				// Front page menu-bar logo max height
				if ( ! empty( $frontpage_logo_max_height_desktop ) && '50' != $frontpage_logo_max_height_desktop ) {
					$css .= '.frontpage-menu-bar .custom-logo{max-height:'. $frontpage_logo_max_height_desktop .'px;}';
				}
				if ( ! empty( $frontpage_logo_max_height_tablet ) ) {
					$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em){.frontpage-menu-bar .custom-logo{max-height:'. $frontpage_logo_max_height_tablet .'px;}}';
				}
		...
		// Add header classes on all other pages
    		...
    		$content_logo_max_height_tablet = get_theme_mod( 'ubik_header_content_site_logo_max_height_tablet', '50' );
				...
				if ( ! empty( $image_header_height_desktop ) ) {
					$css .= '.image-header{min-height:'. $image_header_height_desktop .'px;}';
					// $css .= '.admin-bar .image-header{min-height: calc('. $image_header_height_desktop .'vh - 32px);}';
				}
				if ( ! empty( $image_header_height_tablet ) ) {
					$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em) {.image-header{min-height:'. $image_header_height_tablet .'px;}}';
					// $css .= '@media screen and (min-width: 782px) and (max-width: 63.9375em) {.admin-bar .image-header{min-height: calc('. $image_header_height_tablet .'vh - 32px);}}';
					// $css .= '@media screen and (min-width: 40em) and (max-width: 781.9px) {.admin-bar .image-header{min-height: calc('. $image_header_height_tablet .'vh - 46px;}}';
				}
				if ( ! empty( $image_header_height_mobile ) ) {
					$css .= '@media screen and (max-width: 39.9375em) {.image-header{min-height:'. $image_header_height_mobile .'px;}}';
				...
				if ( ! empty( $bg_img ) ) {
					...
					$css .= '.image-header{background-image: url( '. $bg_img .' );}';

					if ( ! empty( $bg_img_position ) ) {
						$css .= '.image-header{background-position:'. $bg_img_position .';}';
					}

					if ( ! empty( $bg_img_attachment ) ) {
						$css .= '.image-header{background-attachment:'. $bg_img_attachment .';}';
					}

					if ( ! empty( $bg_img_repeat ) ) {
						$css .= '.image-header{background-repeat:'. $bg_img_repeat .';}';
					}

					if ( ! empty( $bg_img_size ) ) {
						$css .= '.image-header{background-size:'. $bg_img_size .';}';
					}
				...
				if ( ! empty( $content_logo_max_height_desktop ) && '50' != $content_logo_max_height_desktop ) {
					$css .= '.header-content .custom-logo{max-height:'. $content_logo_max_height_desktop .'px;}';
				}
				if ( ! empty( $content_logo_max_height_tablet ) ) {
					$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em){.header-content .custom-logo{max-height:'. $content_logo_max_height_tablet .'px;}}';
				}
				if ( ! empty( $content_logo_max_height_mobile ) ) {
					$css .= '@media screen and (max-width: 39.9375em){.header-content .custom-logo{max-height:'. $content_logo_max_height_mobile .'px;}}';
				}
				...
				if ( ! empty( $content_tagline_font_size_desktop ) && '1' == get_theme_mod('ubik_header_content_site_tagline_typography_heading', '0') ) {
					$css .= '.header-content__tagline .site-tagline{font-size:'. $content_tagline_font_size_desktop .'px;}';
				}
				if ( ! empty( $content_tagline_font_size_tablet ) && '1' == get_theme_mod('ubik_header_content_site_tagline_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.header-content__tagline .site-tagline{font-size:'. $content_tagline_font_size_tablet .'px;}}';
				}
				if ( ! empty( $content_tagline_font_size_mobile ) && '1' == get_theme_mod('ubik_header_content_site_tagline_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 39.9375em) {.header-content__tagline .site-tagline{font-size:'. $content_tagline_font_size_mobile .'px;}}';
				}
				...
				if ( ! empty( $content_page_title_font_size_desktop ) && '1' == get_theme_mod('ubik_header_content_page_title_typography_heading', '0') ) {
					$css .= '.header-content__page-title .site-page-title{font-size:'. $content_page_title_font_size_desktop .'px;}';
				}
				if ( ! empty( $content_page_title_font_size_tablet ) && '1' == get_theme_mod('ubik_header_content_page_title_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.header-content__page-title .site-page-title{font-size:'. $content_page_title_font_size_tablet .'px;}}';
				}
				if ( ! empty( $content_page_title_font_size_mobile ) && '1' == get_theme_mod('ubik_header_content_page_title_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 39.9375em) {.header-content__page-title .site-page-title{font-size:'. $content_page_title_font_size_mobile .'px;}}';
				}
				...
				if ( ! empty( $content_breadcrumbs_font_size_desktop ) && '1' == get_theme_mod('ubik_header_content_breadcrumbs_typography_heading', '0') ) {
					$css .= '.header-content__breadcrumbs .breadcrumbs{font-size:'. $content_breadcrumbs_font_size_desktop .'px;}';
				}
				if ( ! empty( $content_breadcrumbs_font_size_tablet ) && '1' == get_theme_mod('ubik_header_content_breadcrumbs_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.header-content__breadcrumbs .breadcrumbs{font-size:'. $content_breadcrumbs_font_size_tablet .'px;}}';
				}
				if ( ! empty( $content_breadcrumbs_font_size_mobile ) && '1' == get_theme_mod('ubik_header_content_breadcrumbs_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 39.9375em) {.header-content__breadcrumbs .breadcrumbs{font-size:'. $content_breadcrumbs_font_size_mobile .'px;}}';
				}
				...
				if ( ! empty( $content_nav_font_size_desktop ) && '1' == get_theme_mod('ubik_header_content_nav_typography_heading', '0') ) {
					$css .= '.header-content__nav{font-size:'. $content_nav_font_size_desktop .'px;}';
				}
				if ( ! empty( $content_nav_font_size_tablet ) && '1' == get_theme_mod('ubik_header_content_nav_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.header-content__nav{font-size:'. $content_nav_font_size_tablet .'px;}}';
				}
				if ( ! empty( $content_nav_font_size_mobile ) && '1' == get_theme_mod('ubik_header_content_nav_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 39.9375em) {.header-content__nav{font-size:'. $content_nav_font_size_mobile .'px;}}';
				}
				...
				if ( ! empty( $content_text_font_size_desktop ) && '1' == get_theme_mod('ubik_header_content_text_typography_heading', '0') ) {
					$css .= '.header-content__text, .header-content__text p{font-size:'. $content_text_font_size_desktop .'px;}';
				}
				if ( ! empty( $content_text_font_size_tablet ) && '1' == get_theme_mod('ubik_header_content_text_typography_heading', '0') ) {
					$css .= '@media screen and (max-width: 63.9375em) {.header-content__text, .header-content__text p{font-size:'. $content_text_font_size_tablet .'px;}}';
				}
    		...
    		$menubar_logo_max_height_tablet = get_theme_mod( 'ubik_menubar_logo_max_height_tablet', '50' );
				...
				if ( ! empty( $menubar_bg_color ) && ! ubik_image_header_menubar_deactivate() && '1' == get_theme_mod('ubik_menubar_color_heading', '0') ) {
					$css .= '#header .menu-bar{background-color:'. $menubar_bg_color .';}';
				}
				...
				if ( ! empty( $menubar_borders_color ) && ! ubik_image_header_menubar_deactivate() && '1' == get_theme_mod('ubik_menubar_color_heading', '0') ) {
					$css .= '#header .menu-bar-inner{border-color:'. $menubar_borders_color .';}';
				}
				
				// Menu-bar logo max height
				if ( ! empty( $menubar_logo_max_height_desktop ) && '50' != $menubar_logo_max_height_desktop ) {
					$css .= '.menu-bar .custom-logo{max-height:'. $menubar_logo_max_height_desktop .'px;}';
				}
				if ( ! empty( $menubar_logo_max_height_tablet ) ) {
					$css .= '@media screen and (min-width: 40em) and (max-width: 63.9375em){.menu-bar .custom-logo{max-height:'. $menubar_logo_max_height_tablet .'px;}}';
				}
    ...
    $css = '';
		...
		if ( ubik_frontpage_top_bar_display() ) {
			...
			if ( ! empty( $frontpage_top_bar_height ) && '2' != $frontpage_top_bar_height ) {
				$css .= '.frontpage-top-bar-inner{height:'. $frontpage_top_bar_height .'em;}';

				// Ajust frontpage classic vertical bar footer padding bottom
				$css .= '.has-classic-vertical-bar.has-frontpage-top-bar .classic-vertical-bar-footer, .has-classic-vertical-bar.has-frontpage-top-bar .frontpage-classic-vertical-bar-footer{padding-bottom:'. $frontpage_top_bar_height .'em;}';
			}
			...
			if ( ! empty( $frontpage_top_bar_text_font_size_desktop ) && '1' == get_theme_mod('ubik_frontpage_top_bar_text_typography_heading', '0') ) {
				$css .= '.frontpage-top-bar-text, .frontpage-top-bar-text p{font-size:'. $frontpage_top_bar_text_font_size_desktop .'px;}';
			}
			if ( ! empty( $frontpage_top_bar_text_font_size_tablet ) && '1' == get_theme_mod('ubik_frontpage_top_bar_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.frontpage-top-bar-text, .frontpage-top-bar-text p{font-size:'. $frontpage_top_bar_text_font_size_tablet .'px;}}';
			}
			if ( ! empty( $frontpage_top_bar_text_font_size_mobile ) && '1' == get_theme_mod('ubik_frontpage_top_bar_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.frontpage-top-bar-text, .frontpage-top-bar-text p{font-size:'. $frontpage_top_bar_text_font_size_mobile .'px;}}';
			}
		...
		// Top bar custom style
			...
			if ( ! empty( $top_bar_height ) && '2' != $top_bar_height ) {
				$css .= '.top-bar-inner{height:'. $top_bar_height .'em;}';

				// Ajust classic vertical bar footer padding bottom
				$css .= '.has-classic-vertical-bar.has-top-bar .classic-vertical-bar-footer, .has-classic-vertical-bar.has-top-bar .frontpage-classic-vertical-bar-footer{padding-bottom:'. $top_bar_height .'em;}';
			}
			...
			if ( ! empty( $top_bar_text_font_size_desktop ) && '1' == get_theme_mod('ubik_top_bar_text_typography_heading', '0') ) {
				$css .= '.top-bar-text, .top-bar-text p{font-size:'. $top_bar_text_font_size_desktop .'px;}';
			}
			if ( ! empty( $top_bar_text_font_size_tablet ) && '1' == get_theme_mod('ubik_top_bar_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.top-bar-text, .top-bar-text p{font-size:'. $top_bar_text_font_size_tablet .'px;}}';
			}
			if ( ! empty( $top_bar_text_font_size_mobile ) && '1' == get_theme_mod('ubik_top_bar_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.top-bar-text, .top-bar-text p{font-size:'. $top_bar_text_font_size_mobile .'px;}}';
			}
    ...
    $css = '';
		...
		if ( ubik_frontpage_classic_vertical_bar_display() ) {
			...
			if ( ! empty( $frontpage_classic_vertical_bar_nav_font_size_desktop ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_nav_typography_heading', '0') ) {
				$css .= '.frontpage-classic-vertical-bar-nav{font-size:'. $frontpage_classic_vertical_bar_nav_font_size_desktop .'px;}';
			}
			if ( ! empty( $frontpage_classic_vertical_bar_nav_font_size_tablet ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_nav_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.frontpage-classic-vertical-bar-nav{font-size:'. $frontpage_classic_vertical_bar_nav_font_size_tablet .'px;}}';
			}
			if ( ! empty( $frontpage_classic_vertical_bar_nav_font_size_mobile ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_nav_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.frontpage-classic-vertical-bar-nav{font-size:'. $frontpage_classic_vertical_bar_nav_font_size_mobile .'px;}}';
			}
			...
			if ( ! empty( $frontpage_classic_vertical_bar_text_font_size_desktop ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_text_typography_heading', '0') ) {
				$css .= '.frontpage-classic-vertical-bar-text, .frontpage-classic-vertical-bar-text p{font-size:'. $frontpage_classic_vertical_bar_text_font_size_desktop .'px;}';
			}
			if ( ! empty( $frontpage_classic_vertical_bar_text_font_size_tablet ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.frontpage-classic-vertical-bar-text, .frontpage-classic-vertical-bar-text p{font-size:'. $frontpage_classic_vertical_bar_text_font_size_tablet .'px;}}';
			}
			if ( ! empty( $frontpage_classic_vertical_bar_text_font_size_mobile ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.frontpage-classic-vertical-bar-text, .frontpage-classic-vertical-bar-text p{font-size:'. $frontpage_classic_vertical_bar_text_font_size_mobile .'px;}}';
			}
			...
			if ( ! empty( $frontpage_classic_vertical_bar_footer_text_font_size_desktop ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_footer_text_typography_heading', '0') ) {
				$css .= '.frontpage-classic-vertical-bar-footer-text, .frontpage-classic-vertical-bar-footer-text p{font-size:'. $frontpage_classic_vertical_bar_footer_text_font_size_desktop .'px;}';
			}
			if ( ! empty( $frontpage_classic_vertical_bar_footer_text_font_size_tablet ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_footer_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.frontpage-classic-vertical-bar-footer-text, .frontpage-classic-vertical-bar-footer-text p{font-size:'. $frontpage_classic_vertical_bar_footer_text_font_size_tablet .'px;}}';
			}
			if ( ! empty( $frontpage_classic_vertical_bar_footer_text_font_size_mobile ) && '1' == get_theme_mod('ubik_frontpage_classic_vertical_bar_footer_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.frontpage-classic-vertical-bar-footer-text, .frontpage-classic-vertical-bar-footer-text p{font-size:'. $frontpage_classic_vertical_bar_footer_text_font_size_mobile .'px;}}';
			}
		...
		// Classic vertical bar custom style
			...
			if ( ! empty( $classic_vertical_bar_nav_font_size_desktop ) && '1' == get_theme_mod('ubik_classic_vertical_bar_nav_typography_heading', '0') ) {
				$css .= '.classic-vertical-bar-nav{font-size:'. $classic_vertical_bar_nav_font_size_desktop .'px;}';
			}
			if ( ! empty( $classic_vertical_bar_nav_font_size_tablet ) && '1' == get_theme_mod('ubik_classic_vertical_bar_nav_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.classic-vertical-bar-nav{font-size:'. $classic_vertical_bar_nav_font_size_tablet .'px;}}';
			}
			if ( ! empty( $classic_vertical_bar_nav_font_size_mobile ) && '1' == get_theme_mod('ubik_classic_vertical_bar_nav_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.classic-vertical-bar-nav{font-size:'. $classic_vertical_bar_nav_font_size_mobile .'px;}}';
			}
			...
			if ( ! empty( $classic_vertical_bar_text_font_size_desktop ) && '1' == get_theme_mod('ubik_classic_vertical_bar_text_typography_heading', '0') ) {
				$css .= '.classic-vertical-bar-text, .classic-vertical-bar-text p{font-size:'. $classic_vertical_bar_text_font_size_desktop .'px;}';
			}
			if ( ! empty( $classic_vertical_bar_text_font_size_tablet ) && '1' == get_theme_mod('ubik_classic_vertical_bar_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.classic-vertical-bar-text, .classic-vertical-bar-text p{font-size:'. $classic_vertical_bar_text_font_size_tablet .'px;}}';
			}
			if ( ! empty( $classic_vertical_bar_text_font_size_mobile ) && '1' == get_theme_mod('ubik_classic_vertical_bar_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.classic-vertical-bar-text, .classic-vertical-bar-text p{font-size:'. $classic_vertical_bar_text_font_size_mobile .'px;}}';
			}
			...
			if ( ! empty( $classic_vertical_bar_footer_text_font_size_desktop ) && '1' == get_theme_mod('ubik_classic_vertical_bar_footer_text_typography_heading', '0') ) {
				$css .= '.classic-vertical-bar-footer-text, .classic-vertical-bar-footer-text p{font-size:'. $classic_vertical_bar_footer_text_font_size_desktop .'px;}';
			}
			if ( ! empty( $classic_vertical_bar_footer_text_font_size_tablet ) && '1' == get_theme_mod('ubik_classic_vertical_bar_footer_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 63.9375em) {.classic-vertical-bar-footer-text, .classic-vertical-bar-footer-text p{font-size:'. $classic_vertical_bar_footer_text_font_size_tablet .'px;}}';
			}
			if ( ! empty( $classic_vertical_bar_footer_text_font_size_mobile ) && '1' == get_theme_mod('ubik_classic_vertical_bar_footer_text_typography_heading', '0') ) {
				$css .= '@media screen and (max-width: 39.9375em) {.classic-vertical-bar-footer-text, .classic-vertical-bar-footer-text p{font-size:'. $classic_vertical_bar_footer_text_font_size_mobile .'px;}}';
			}
  ...
  function ubik_footer_css( $output ) {
		...
		if ( ubik_frontpage_footer_display() ) {
			...
			if ( ! empty( $frontpage_footer_height_desktop ) ) {
				$css .= '.frontpage-footer{height:'. $frontpage_footer_height_desktop .'px;}';
			}
			if ( ! empty( $frontpage_footer_height_tablet ) ) {
				$css .= '@media screen and (max-width: 63.9375em) {.frontpage-footer{height:'. $frontpage_footer_height_tablet .'px;}}';
			}
			if ( ! empty( $frontpage_footer_height_mobile ) ) {
				$css .= '@media screen and (max-width: 39.9375em) {.frontpage-footer{height:'. $frontpage_footer_height_mobile .'px;}}';
			}

			// Front page footer logo max height
			if ( ! empty( $frontpage_footer_logo_height_desktop ) ) {
				$css .= '.frontpage-footer-logo .custom-logo{max-height:'. $frontpage_footer_logo_height_desktop .'px;}';
			}
			if ( ! empty( $frontpage_footer_logo_height_tablet ) ) {
				$css .= '@media screen (max-width: 63.9375em) {.frontpage-footer-logo .custom-logo{max-height:'. $frontpage_footer_logo_height_tablet .'px;}}';
			}
			if ( ! empty( $frontpage_footer_logo_height_mobile ) ) {
				$css .= '@media screen and (max-width: 39.9375em) {.frontpage-footer-logo .custom-logo{max-height:'. $frontpage_footer_logo_height_mobile .'px;}}';
      }
			...
			if ( ! empty( $footer_height_desktop ) ) {
				$css .= '.site-footer{height:'. $footer_height_desktop .'px;}';
			}
			if ( ! empty( $footer_height_tablet ) ) {
				$css .= '@media screen and (max-width: 63.9375em) {.site-footer{height:'. $footer_height_tablet .'px;}}';
			}
			if ( ! empty( $footer_height_mobile ) ) {
				$css .= '@media screen and (max-width: 39.9375em) {.site-footer{height:'. $footer_height_mobile .'px;}}';
			}
			
			// footer logo max height
			if ( ! empty( $footer_logo_height_desktop ) ) {
				$css .= '.footer-logo .custom-logo{max-height:'. $footer_logo_height_desktop .'px;}';
			}
			if ( ! empty( $footer_logo_height_tablet ) ) {
				$css .= '@media screen and (max-width: 63.9375em) {.footer-logo .custom-logo{max-height:'. $footer_logo_height_tablet .'px;}}';
			}
			if ( ! empty( $footer_logo_height_mobile ) ) {
				$css .= '@media screen and (max-width: 39.9375em) {.footer-logo .custom-logo{max-height:'. $footer_logo_height_mobile .'px;}}';
      }
