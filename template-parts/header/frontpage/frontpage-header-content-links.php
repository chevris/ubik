<?php
/**
 * Front page header content links template part.
 *
...
$defaults = array(
  array(
    ...
    'link_custom_border_color'							=> '#929292',
...
$settings = get_theme_mod( 'ubik_frontpage_header_content_links_custom_repeater', $defaults );
...
if ( $settings ) :
  ...
  foreach( $settings as $setting ) : 
    ...
    <a id="frontpage-header-content-link-<?php echo esc_attr( str_replace( ' ', '_', $text ) ); ?>" href="<?php echo esc_url( $url ); ?>">
